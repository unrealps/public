...
%global _release          1
%global _kubectx_version  0.9.5
%global _kubens_version   0.9.5
...
%license LICENSE.kubectx LICENSE.kubens kubetail-%{_kubetail_version}/LICENSE.kubetail LICENSE.stern
